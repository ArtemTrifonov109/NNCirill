...
def compare_models():
    """Сравнение всех моделей Кохонена"""
    ...
    for model_name in model_dirs:
        ...
        try:
            # Создание новой сети Кохонена с теми же параметрами
            ...
            # Для сети Кохонена обучение проводится на тестовых данных, так как оригинальные веса недоступны
            # Обучение с уменьшенным числом итераций для получения разумных результатов
            kohonen.train(X_test, max_iterations=10, log_interval=5)  # Уменьшено с 20 до 10 для скорости
